'''
Example 1: Deep Neural Network  from scrach
...
Xts, yts,_ = ds.create_dataset(200, dtype[0],0.1,varargin = 'PRESET');

print(X.shape, y.shape)


NN = deepNet(X,y,Xts=Xts, yts=yts, Net = [3,3],NetAf =['tanh'], alpha=0.01,miniBatchSize = 0.3, printCostAt =100,AdamOpt=True,lambd=0,keepProb =[1.0])
